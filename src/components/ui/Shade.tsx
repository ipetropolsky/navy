 ...
 *
 * Выходов четыре: крестик в верхнем углу, нажатие мимо, свайп вниз за ручку и Esc. Ручка —
 * единственное место, за которое шторку тянут: внутри неё нажимают кнопки, мотают содержимое
 * и выделяют текст, и отбирать у них движение пальца нечем. Esc, в отличие от остальных трёх,
 * не свой у каждой шторки, а один слушатель на всё приложение (см. `ShadeStack`): закрывает
 * он ровно верхнюю из открытых, а не все разом.
 *

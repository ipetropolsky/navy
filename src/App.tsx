...
export default function App() {
    ...
    // Разговор убирают не только кнопкой, но и свайпом по кадру: движение вверх уводит его
    // с экрана, движение вниз возвращает — палец ведёт кромку разговора туда, куда она поедет.
    ...
    useSwipe(sceneRef, shown ? 'up' : 'down', toggleChat);

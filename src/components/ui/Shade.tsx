 ...
 *
 * Выходов три: крестик в верхнем углу, нажатие мимо и свайп вниз. Тянут за любое место, кроме
 ...
 * до верха список вниз больше не едет, и свайп с него достаётся шторке.
 *
 ...
 * останавливаться, и нарисовать себя по тому сдвигу, который свайп насчитал.
 */
export default function Shade({
    ...
    // Шторка ходит вниз всегда — она и приезжает снизу, — и ось свайпу поэтому не задаётся.

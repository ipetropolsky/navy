 ...
 * расходятся бортами (sideBySide). Кто места не выбирал, встаёт случайно: строй не должен
 * выглядеть построенным. Свободная
 ...
 * по бортам и у самой кромки, а двум крупным тесно уже на середине рейда. Так пара стала
 * обычным делом — каждая шестая расстановка и на любой из семи линий, не закрытых островом.
 *

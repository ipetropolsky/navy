 ...
 * не должен. Свёрнутый телефонный кадр не в счёт: неба в нём полоса в 60–135px, и тридцать
 * пикселей съели бы добрую его половину. Месяц на телефоне и вовсе отмерен не от горизонта,
 * а от строки состояния канала — в обеих раскладках одинаково.
 *

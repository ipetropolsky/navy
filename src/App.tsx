...
export default function App() {
     ...
     * форму приспускают потягом: коробка уходит вниз (сбоку — вправо), кадр раздаётся на
     * освободившееся, отметки разъезжаются. Отпущенная у своей кромки, коробка встаёт обратно;
     ...
     * Ось у него меняется вместе с раскладкой: под кадром коробку приспускают вниз, сбоку —
     * отодвигают вправо, потому что там она стоит у правой кромки.
     */
    const lower = useSheetDrag({
        open: formOpen || joinOpen,
        axis: atSide ? 'x' : 'y',
        magnet: FORM_MAGNET,
    ...
    return (
        ...
        >
            ...
            <main
                ...
                // коробке значило бы отнять у ленты то и другое разом.
                {...(joinOpen ? lower.handlers : {})}
            >
            ...
            {formSlide.mounted && me && (
                <div
                    ...
                    // внизу экрана у них одна, и правила движения одни.
                    {...lower.handlers}

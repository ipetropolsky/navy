...
Корабль в строчке о перемене не назван: она стоит в его же цепочке, с его аватаркой и позывным
над первой строкой, а полный титул в каждой из трёх сделал бы из них три почти одинаковых абзаца.

 ...
 *
 * Выходов три: крестик в верхнем углу, нажатие мимо и потяг вниз. Тянут за любое место, кроме
 * текстового поля, — попадать пальцем в полоску шириной в палец занятие для тех, кому некуда
 * спешить. Своя прокрутка внутри забирает движение себе, пока ей есть куда мотаться: домотанный
 * до верха список вниз больше не едет, и потяг с него достаётся шторке.
 *

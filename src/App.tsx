...
export default function App() {
    ...
    // Сколько панели видно на экране. Одно число на всю коробку — и на разговор, и на стоящий
    // поверх него слой: коробка внизу экрана одна, и занимают её всегда вместе.
    //

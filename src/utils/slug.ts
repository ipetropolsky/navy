 ...
 * и набирают руками, поэтому в ней только латинские буквы и дефис между словами.
 *
...
/** Годится ли строка в адрес канала: только строчные латинские буквы, дефис — между словами. */
...
/**
 * Превращает название в адрес: транслитерирует, всё нелатинское заменяет дефисом,
 * лишние дефисы схлопывает. Результат может оказаться пустым — например, если название
 * состоит из одних цифр, — и тогда предлагать нечего, пусть вводят руками.
 */

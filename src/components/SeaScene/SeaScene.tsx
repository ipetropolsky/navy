                    ...
                    >
                        ...
                        <div
                            className={[
                                ...
                                .join(' ')}
                        >
                            {/* viewBox нет намеренно: без него единица разметки — пиксель экрана,
                                и круг у каждого места свой не по масштабу, а по размеру. Штрих
                                тогда один на весь рейд: дальнему кругу его достаётся меньше,
                                зато тот же самый, а не сжатый в неразличимую крошку. */}
                            <svg className={styles.berthRing} aria-hidden="true">

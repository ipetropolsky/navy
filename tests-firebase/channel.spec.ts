 ...
 * входа. Правила читают открыто (firestore.rules: allow read: if true) — рейд виден кому
 * угодно по ссылке, — а вот разговор до входа не открывается ни при каких обстоятельствах:
 * встать на рейд, не назвавшись, нельзя (см. docs/FIREBASE.md, «Что видит гость»).
 *

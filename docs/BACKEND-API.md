...
У переоснащения фраза короткая: только «стало», без «было» и без «теперь». Обе половины
отличались одним-двумя словами, и строчка выходила вдвое длиннее без нового смысла; что
именно поменялось, видно по пометке на изменившемся, а стрелка занимает место выброшенного
«теперь».

...
interface SeaProps {
    ...
    frames?: number[];
    /**
     * Какой снимок отражать в режиме mirror. У обоих лунная дорожка почти по
     * центру, так что при отражении свет стоит на месте; различаются рисунок
     * ряби, пропорция кадра и цвет нижней кромки.
     */

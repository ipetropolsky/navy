...
mutation SeedIndependentTables @transaction {
    ...
    movie_insertMany(
        data: [{ id: "m-1", title: "Inception", genre: "sci-fi" }, { id: "m-2", title: "The Matrix", genre: "action" }]
    )

    actor_insertMany(data: [{ id: "a-1", name: "Leonardo DiCaprio" }, { id: "a-2", name: "Keanu Reeves" }])
    ...
    movie_insert(
        data: {
            ...
            reviews_on_movie: [
                ...
                { id: "r-2", rating: 4, reviewText: "Visually stunning but complex.", user: { id: "user-456" } }
            ]
        }
    )
}

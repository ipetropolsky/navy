 ...
 *
 * Лежит это в utils, а не в backend, хотя пришло оттуда: память вкладки нужна не только
 * эмулятору сервера, но и раскладке (см. hooks/useLayout), а она про бэкенд не знает ничего.
 */
